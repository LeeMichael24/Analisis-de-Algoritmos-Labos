...
public:
    ...
    // Función privada para liberar nodos recursivamente
...
// Destructor de mundo BST
Red_Black_Tree::~Red_Black_Tree()
{
    // Llama a la función privada que libera los nodos de forma recursiva
    FreeNodes(root);
...
// Función privada para liberar los nodos recursivamente
